...
(NULL, 'DOM', 'EBDOM', 'El profesor(a) muestra dominio y experiencia en los temas de la Unidad de Formación:', 'TEACHER', 'NUMERIC'),
(NULL, 'RET', 'EBRET', 'El profesor(a) me retó para dar lo mejor de mi (desarrollar nuevas habilidades, nuevos conceptos e ideas, pensar de manera diferente, etc.):', 'TEACHER', 'NUMERIC'),
(NULL, 'REC', 'E REC', 'En general, mi experiencia de aprendizaje con el profesor(a) fue:', 'TEACHER', 'NUMERIC'),
...
(NULL, 'COM', 'EBCOMEN', '¿Qué le comentarías a un estudiante que quisiera inscribir la Unidad de Formación con este(a) profesor(a)?', 'TEACHER', 'TEXT'),
